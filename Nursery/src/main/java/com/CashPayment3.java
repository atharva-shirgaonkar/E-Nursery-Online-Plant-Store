...
@WebServlet("/CashPayment3")
public class CashPayment3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String qur3="select *from pot_book where cust_id='"+uid+"' and item_id='"+fid+"' and item_quant='"+cust_qunt+"' and payment_status='done'";
