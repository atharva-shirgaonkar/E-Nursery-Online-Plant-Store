...
@WebServlet("/conlinePayment2")
public class conlinePayment2 extends HttpServlet {
...
String plantname=session.getAttribute("plantname").toString();
		...
		try {
			...
			/*
			String qur3="select *from seed_book where cust_id='"+uid+"' and item_quant='"+cust_qunt+"' and item_id='"+fid+"' and payment_status='done'";
