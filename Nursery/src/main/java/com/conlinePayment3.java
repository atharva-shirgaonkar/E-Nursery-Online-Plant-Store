...
@WebServlet("/conlinePayment3")
public class conlinePayment3 extends HttpServlet {
...
HttpSession session=request.getSession();
		...
		try {
			...
			String qur3="select *from pot_book where cust_id='"+uid+"' and item_quant='"+cust_qunt+"' and item_id='"+fid+"' and payment_status='done'";
		...
		String qur="insert into pot_book(custname,cust_id,plant_cat,item_name,item_id,item_quant,total_cost,address,payment_type) values('"+username+"','"+uid+"','"+catagory+"','"+pic+"','"+fid+"','"+cust_qunt+"','"+totalcost+"','"+address+"','"+pay_type+"')";
