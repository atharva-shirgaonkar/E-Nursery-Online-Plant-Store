				...
				<div class="col-md-offset-3 col-md-8">
					<div class="form" style="background-color: white;">
						...
						<%
							...
							String qur1 = "select *from cust_query where answer='not given'";
						...
						<table border="1px solid black" style="text-align: center;">
							...
							<tr>
								...
								<td><button type="submit" onclick="location.href='./GiveAnswer.jsp?username=<%=rs1.getString("username")%>&userid=<%=rs1.getString("userid")%>&subject=<%=rs1.getString("subject")%>&cquery=<%=rs1.getString("cquery")%>'">Answer</button> </td>
