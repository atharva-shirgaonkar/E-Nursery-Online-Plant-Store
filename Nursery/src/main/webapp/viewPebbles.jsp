			...
			<div class="col-md-12">
				<div class="col-md-offset-3 col-md-8">
					<div class="form">
						...
						<h2>All Pebbles Details</h2>
						<h2>Pebbles by Color</h2>
						<%
							con = ConnectionProvider.getConnection();
							String qur1 = "select *from nursery_items where item_type='Pebbles by Color'";
						...
						<table border="1px solid black" style="text-align: center;">
							...
							<tr>
								...
								<td><button type="submit" style="margin: 20px">Buy</button>
								</td>
			...
			<div class="col-md-12">
				<div class="col-md-offset-3 col-md-8">
					<div class="form">
						...
						<h2>Black color pebbles</h2>
						<%
							con = ConnectionProvider.getConnection();
							String qur2 = "select *from nursery_items where item_type='Black color pebbles'";
			...
			<div class="col-md-12">
				<div class="col-md-offset-3 col-md-8" style="width: 100%">
					<div class="form">
						...
						<h2>Brown color pebbles</h2>
						<%
							con = ConnectionProvider.getConnection();
							String qur3 = "select *from nursery_items where item_type='Brown color pebbles'";
			...
			<div class="col-md-12">
				<div class="col-md-offset-3 col-md-8" style="width: 100%">
					<div class="form">
						...
						<h2>Mix color pebbles</h2>
						<%
							con = ConnectionProvider.getConnection();
							String qur4 = "select *from nursery_items where item_type='Mix color pebbles'";
