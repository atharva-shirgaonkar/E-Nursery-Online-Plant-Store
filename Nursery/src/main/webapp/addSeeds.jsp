...
<tr>
<td>Item</td>
<td><input type="text" name="item" value="seeds"> </td>
</tr>
								<tr>
									...
									<td><select name="pltype">
											...
											<%
												...
												while (rs.next()) {
											%>
											<option name="<%=rs.getString("seeds")%>"
												value="<%=rs.getString("seeds")%>"><%=rs.getString("seeds")%></option>
											<%
												}
											%>
								...
								<tr>
									...
									<td><input type="text" name="plname"
										placeholder="Enter seed Name" required></td>
								</tr>

								<tr>
									<td>Quantity</td>
									<td><input type="text" name="plqnt"
										placeholder="Enter Seeds quantity" required></td>
								</tr>
