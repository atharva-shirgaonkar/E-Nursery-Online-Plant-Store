	...
	String plantname=session.getAttribute("plantname").toString();
		...
		if (cust_qunt > item_quntity) {
			...
			if(plantname.equals("english"))
			{
				...
				response.sendRedirect("englishSeeds.jsp?stock=not");
			...
			{
				response.sendRedirect("vegtableSeeds.jsp?stock=not");	
			}
			...
			<div class="col-md-12">
				...
				<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
					<div class="form" style="background-color: white;">
						...
						<form action="./CashPayment2" method="post">
			...
			<div class="col-md-12">
				...
				<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
					<div class="form" style="background-color: white;">
						...
						<form action="./conlinePayment2" method="post" name="ureg">
