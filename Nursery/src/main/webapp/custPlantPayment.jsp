		...
		String plantname=session.getAttribute("plantname").toString();
			...
			if (cust_qunt > item_quntity) {
				...
				if(plantname.equals("bamboo"))
				{
					...
					response.sendRedirect("bambooPlants.jsp?stock=not");
					
				}
				else if(plantname.equals("cactus"))
				{
					response.sendRedirect("cactusPlants.jsp?stock=not");
				}
				else if(plantname.equals("Flowering Creepers"))
				{
					response.sendRedirect("flowersPlants.jsp?stock=not");
				}
				else{
					response.sendRedirect("aquaticPlants.jsp?stock=not");	
				}
				...
				<div class="col-md-12">
					...
					<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
						<div class="form" style="background-color: white;">
							...
							<form action="./conlinePayment" method="post" name="ureg">
