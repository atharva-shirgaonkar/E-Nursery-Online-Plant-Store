	...
	String plantname = session.getAttribute("plantname").toString();
		...
		if (cust_qunt > item_quntity) {
			...
			if(plantname.equals("blue"))
			{
				...
				response.sendRedirect("bluePebbles.jsp?stock=not");
				
			}
			else if(plantname.equals("black"))
			{
				response.sendRedirect("blackPebbles.jsp?stock=not");
			}
			else 
			{
				response.sendRedirect("standerdPebbles.jsp?stock=not");	
			}
			...
			<div class="col-md-12">
				...
				<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
					<div class="form" style="background-color: white;">
						...
						<form action="./CashPayment4" method="post">
			...
			<div class="col-md-12">
				...
				<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
					<div class="form" style="background-color: white;">
						...
						<form action="./conlinePayment4" method="post" name="ureg">
...
<input type="hidden" name="pay_type" value="online">
								...
								<tr>
									...
									<tr>
									<td><input type="password" name="cvv" placeholder="Enter CVV Pin" onblur="return  validuaernameandpass1()" required></td>
								</tr>
