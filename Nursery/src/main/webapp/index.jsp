 ...
 <jsp:include page="header/header.jsp"/>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2>Largest Seeds <span>& Flowering Bulbs</span><br>3000+ rare,exotic imported Seeds </h2>
     
    </div>

    <div id="intro-carousel" class="owl-carousel" >
      <div class="item" style="background-image: url('img/intro-carousel/12.jpg');"></div>
      <div class="item" style="background-image: url('img/intro-carousel/13.jpg');"></div>
      <div class="item" style="background-image: url('img/intro-carousel/14.jpg');"></div>
      <div class="item" style="background-image: url('img/intro-carousel/16.jpg');"></div>
      <div class="item" style="background-image: url('img/intro-carousel/21.jpg');"></div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft">
              ...
              <center><h4 class="title"><a href="">Buy Plants Online</a></center></h4><br><br><br><br>
              <p class="description"> <h2 style="font-size: 20px;color: Green">Plants by Type:</h2>	 <h2 style="font-size: 12px;color: blue">Aquatic Plants / Avenue Trees / Bamboos / Bonsai Plants / Cactus n Succulents / Climbers n Creepers / Flowering Creepers  n like plants</h2>
...
<h2 style="font-size: 20px;color: Green">Plants by Feature:</h2> <h2 style="font-size: 12px;color: blue">Low Maintenance Plants / Nakshtra Plants / Plants Good for Containers / Plants to Attracts Birds n Butterflies / Drought Tolerant Plants / Aromatic Plants / Ground Cover.</h2>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight">
             ...
             <center><h4 class="title"><a href="">Buy Seeds </a></center>
              </h4><br><br><br><br>
...
<h2 style="font-size: 20px;color: Green">Flower Seeds:</h2> <h2 style="font-size: 12px;color: blue">All Flower Seeds / Fall Flower Seeds (20°C to 30°C) / Rainy Flower Seeds (20°C to 30°C) / Summer Flower Seeds (25°C to 30°C) / Winter Flower Seeds (20°C to 25°C) / Year Round Flower Seeds.</h2>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInLeft" data-wow-delay="0.2s">
              ...
              <center><h4 class="title"><a href="">Pots Online</a></h4></center>
              <br><br><br><br>
...
<h2 style="font-size: 20px;color: Green">Planters by Shape::</h2> <h2 style="font-size: 12px;color: blue">Hexagon Pots / Rectangular Pots / Round Pots / Square Pots / Oval Pots.</h2>
          ...
          <div class="col-lg-6">
            <div class="box wow fadeInRight" data-wow-delay="0.2s">
              ...
              <center><h4 class="title"><a href="">Pebbles Online</a></h4></center><br><br><br><br>
