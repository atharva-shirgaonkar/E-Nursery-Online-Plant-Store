...
<tr>
<td>Item</td>
<td><input type="text" name="item" value="pebbles"> </td>
</tr>
								<tr>
									...
									<td><select name="pltype">
											...
											<%
												...
												while (rs.next()) {
											%>
											<option name="<%=rs.getString("pebbles")%>"
												value="<%=rs.getString("pebbles")%>"><%=rs.getString("pebbles")%></option>
											<%
												}
											%>
								...
								<tr>
									...
									<td><input type="text" name="plname"
										placeholder="Enter pebbles Name" required></td>
								</tr>

								<tr>
									<td>Quantity</td>
									<td><input type="text" name="plqnt"
										placeholder="Enter pebbbles quantity" required></td>
								</tr>
...
<button type="submit">Add Pebbles</button>
