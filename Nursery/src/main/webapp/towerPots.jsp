		...
		<div class="row">
			<div class="col-md-12">
					 ...
					 con=ConnectionProvider.getConnection();
						String qur1="select *from nursery_items where item_type='Flower Tower'"; 
				...
				<div class="col-md-offset-1 col-md-3" style="float: left;margin-bottom: 2%">
	 			...
	 			<div class="form" style="width: auto;padding: 10px" onclick="location.href='./ViewPotDetails.jsp?id=<%=id%>'">
