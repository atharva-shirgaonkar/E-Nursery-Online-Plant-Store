...
<body style="background-image: url('./img/intro-carousel/18.jpg');">
	...
	if(session.getAttribute("username")==null){
		...
		String plantname = session.getAttribute("plantname").toString();
			...
			String []qn=item_qnt.split(" ");
			String qn1=qn[0];
			/* String qn2=qn[1]; */

			//get only int value from KG
			 int quantity = Integer.parseInt(qn1); 
			
			System.out.println("Customer quantity is:"+qn1);
				...
				<div class="col-md-12">
					...
					<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
						<div class="form" style="background-color: white;">
							...
							<form action="custPebblesPayment.jsp" method="post">
								...
								<input type="hidden" name="type" value="<%=type%>">
								 <input	type="hidden" name="pic" value="<%=pic%>">
									 ...
									 <input type="hidden" name="item_qnt" value="<%=quantity%>">  
	...
	%> --%>
							...
							<%
							if(plantname.equals("blue"))
							{
								%>
								<button type="submit"
								onclick="location.href='bluePebbles.jsp?cancel=done'">Cancel</button>
								<%
							}
							
							
							
							else if(plantname.equals("black"))
							{
								%>
								<button type="submit"
								onclick="location.href='blackPebbles.jsp?cancel=done'">Cancel</button>
	<%
							}
							...
							<button type="submit"
								onclick="location.href='standerdPebbles.jsp?cancel=done'">Cancel</button>
