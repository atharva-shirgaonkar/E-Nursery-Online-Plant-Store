			...
			<div class="col-md-12">
				...
				<div class="col-md-offset-3 col-md-5" style="margin-left: 160px">
					<div class="form" style="background-color: white;">
						...
						<form action="custPotPayment.jsp" method="post">
...
<%
						if(plantname.equals("color"))
						{
							%>
							<button type="submit"
							onclick="location.href='colorPots?cancel=done'">Cancel</button>
							<%
						}
						else if(plantname.equals("tower"))
						{
							%>
							<button type="submit"
							onclick="location.href='towerPots?cancel=done'">Cancel</button>
							<%
						}
							...
							%>
							<button type="submit"
							onclick="location.href='standerdPots?cancel=done'">Cancel</button>
							<%
						}
						%>
